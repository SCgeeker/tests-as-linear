---
title: "基礎統計分析皆是線性模型(又名：丹麥式基礎統計教學)"
author: "原作者：Jonas Kristoffer Lindeløv"
...
This document is summarised in the table below. It shows the linear models underlying common parametric and non-parametric tests. Formulating all the tests in the same language highlights the many similarities between them. 你可以直接下載 [PNG圖檔](linear_tests_cheat_sheet.png)或 [PDF檔案](linear_tests_cheat_sheet.pdf).
...
## 單因子變異數分析與Kruskal-Wallis氏無母數檢定 {#anova1}
### 線性模型解說
